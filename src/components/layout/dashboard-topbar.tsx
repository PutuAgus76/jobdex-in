...
function getMobileNavItemClass(isActive: boolean) {
  const base = "shrink-0 rounded-[8px] px-3 py-2 text-sm font-medium transition-colors";
  ...
  return `${base} bg-slate-100 text-slate-700 hover:bg-slate-200 hover:text-slate-950 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-white`;
}
