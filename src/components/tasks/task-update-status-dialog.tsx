      ...
      <div className="w-full max-w-xl rounded-[8px] bg-white shadow-xl">
        ...
        <form className="grid gap-4 p-5" onSubmit={handleSubmit}>
          <label className="block">
            <span className="mb-2 block text-sm font-medium text-slate-700">Status baru</span>
            <select
  ...
  return (
    <label className="block">
      ...
      <textarea
        ...
        className="min-h-24 w-full rounded-[8px] border border-slate-200 bg-white px-3 py-2 text-sm text-slate-950 outline-none transition-colors focus:border-slate-400 focus:ring-4 focus:ring-slate-100"
      />
    </label>
  );
}
